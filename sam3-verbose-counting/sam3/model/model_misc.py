...
class TransformerWrapper(nn.Module):
    ...
    def _reset_parameters(self):
        ...
        # TransformerWrapper resets all matrix-shaped parameters after modules
        # are constructed. Restore LoRA's zero-B initialization so enabling LoRA
        # is initially equivalent to the base model.
